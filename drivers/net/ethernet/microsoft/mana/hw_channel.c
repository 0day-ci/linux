...
static int mana_hwc_get_msg_index(struct hw_channel_context *hwc, u16 *msg_idx)
{
...
static void mana_hwc_put_msg_index(struct hw_channel_context *hwc, u16 msg_idx)
{
	struct gdma_resource *r = &hwc->inflight_msg_res;
	unsigned long flags;
				      ...
				      const struct hwc_rx_oob *rx_oob)
{
	...
	WARN_ON_ONCE(dma_oob->inline_oob_size_div4 != 2 &&
			  ...
			  const void *req, u32 resp_len, void *resp)
{
	...
	mana_hwc_get_msg_index(hwc, &msg_idx);
